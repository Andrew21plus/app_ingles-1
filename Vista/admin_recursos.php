...
<body>
			...
			<ul class="nav navbar-nav">
				...
				<li class="nav-item">
					<form action="mostrar_arch.php" method="POST">
						<input type="hidden" name="video_select" value="15">
						<button type="submit" class="btn btn-primary">Video Ejercicio 1</button>
					</form>
				</li>
				<li class="nav-item">
					<form action="mostrar_arch.php" method="POST">
						<input type="hidden" name="video_select" value="12">
	...
	<div class="modal fade" id="form_modal" aria-hidden="true">
		<div class="modal-dialog">
			<form action="save_archive.php" method="POST" enctype="multipart/form-data">
